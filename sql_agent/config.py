...
_abstract_type_keys: Dict[str, str] = {
    ...
    "dg_agent.model.llm.LLM": "llm_impl",
...
class Settings(BaseSettings):
    ...
    # )
    llm_impl: str = os.environ.get("LLM", "dg_agent.model.llm.vanus.Vanus")
    doc_index_impl: str = os.environ.get(
        "DocIndex", "dg_agent.vector_store.doc_index.mongo_doc.MongoDoc"
    )
    ...
    knowledge_path: Union[str, None] = os.environ.get("KNOWLEDGE_PATH")
...
settings = Settings()
works = os.environ.get("MAX_WORKERS", "4")
